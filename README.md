...
Рекомендуется убирать дубликаты в новых неизвестных плейлистах, для экономия времени.  
...
Функция "Проверка битых" сканирует в многопоточном режиме все станции из таблицы.  
